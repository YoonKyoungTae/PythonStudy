...
file_name = 'json_result_' + str(curr_time) + '.txt'
...
s3.upload_file(file_name, bucket_name, 'toto/{}'.format(file_name))
s3.put_object_acl(ACL='public-read', Bucket=bucket_name, Key='toto/{}'.format(file_name))
